...
const envSchema = z.object({
  ...
  RPC_ETHEREUM: z.string().url('RPC_ETHEREUM must be a valid URL').optional(),
  ...
  RPC_POLYGON: z.string().url('RPC_POLYGON must be a valid URL').optional(),
  RPC_AVALANCHE: z.string().url('RPC_AVALANCHE must be a valid URL').optional(),
  RPC_BNB: z.string().url('RPC_BNB must be a valid URL').optional(),
  RPC_MANTLE: z.string().url('RPC_MANTLE must be a valid URL').optional(),
  RPC_GNOSIS: z.string().url('RPC_GNOSIS must be a valid URL').optional(),
  RPC_POLYGON_ZKEVM: z.string().url('RPC_POLYGON_ZKEVM must be a valid URL').optional(),
  RPC_CELO: z.string().url('RPC_CELO must be a valid URL').optional(),
  ...
  // Block Explorer API Keys (Optional - for token discovery)
  BASESCAN_API_KEY: z.string().optional(),
  ARBISCAN_API_KEY: z.string().optional(),
  BLASTSCAN_API_KEY: z.string().optional(),
